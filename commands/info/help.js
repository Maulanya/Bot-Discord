...
exports.run = async (bot, message, args) => {
  ...
  const color = "#34c6eb";
  let linkSupport = `https://discord.gg/unboxlabs`
  ...
  const embed = new Discord.MessageEmbed()
    .setThumbnail("https://cdn.discordapp.com/attachments/929291256557879336/1169217340798414878/Untitled_design_waifu2x_photo_noise3_scale.png?ex=65549981&is=65422481&hm=f0ed6f0800f2271218bda028&")
    .setColor(color)
